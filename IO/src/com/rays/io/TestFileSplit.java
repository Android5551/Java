...
public class TestFileSplit {
	public static void main(String[] args) throws Exception {
		...
		File file = new File("C:\\Users\\Piyush\\Documents\\CODING\\Java-workspace\\Java\\IO\\src\\com\\rays\\io\\Hellow.txt");
		...
		for (int i = 1; i <= count; i++) {
			...
			BufferedWriter bw = new BufferedWriter(new FileWriter("Hellow.txt" + i + ".txt"));
			bw.write(line);
			bw.close();
		}
